...
if _name_ == '_main_':
    print("=== ULTRA OPTIMIZED REALTIME SERIAL DATA HANDLER ===")
    print("Sending Data Optimizations:")
    print("- HTTP Connection Pooling & Session Reuse")
    print("- Batch Processing (up to 3 items)")
    print("- Fast Timeouts (300ms connect, 1.5s read)")
    print("- Retry Logic dengan Smart Delays") 
    print("- Async Mode untuk Concurrent Processing")
    print("- Connection Health Monitoring")
    print()
    print("Available Endpoints:")
    print("- GET  /api/stats - Performance monitoring")
    print("- POST /api/switch-mode - Switch between sync/async FIFO")
    print("  Body: {'mode': 'sync'} or {'mode': 'async'}")
    print()
    print("Parsing: UNCHANGED (sesuai kode lama)")
    print()
